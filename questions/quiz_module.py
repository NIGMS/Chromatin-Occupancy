...
class MatchingQuiz:
    def __init__(self, json_file, instant_feedback=False, shuffle_questions=False, shuffle_answers=False):
        self.questions = []
        self.answers = {}
        self.user_answers = []
    ...
    def load_questions_from_json(self, json_file):
        ...
        # Load distractors
        self.distractors = data.get("distractors", [])
...
def run_quiz(json_file, instant_feedback=False, shuffle_questions=False, shuffle_answers=False):
    quiz = MatchingQuiz(json_file, instant_feedback, shuffle_questions, shuffle_answers)
    quiz.setup_quiz()
